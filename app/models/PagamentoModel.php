...
class PagamentoModel extends Model {
    public function savePagamento($data) {
        try {
            ...
            $sql = "INSERT INTO pagamentos (id, user_id, filme_id, cpf, cartao, valor, status) VALUES (:id, :user_id, :filme_id, :cpf, :cartao, :valor, :status)";
            ...
            $stmt->bindParam(':cartao', $data['cartao']);
